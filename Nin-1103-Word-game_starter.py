'''
On this project I have collaborated with the following student(s) (if any) : Navy, Tae tae.
'''
...
def load_words(): #reading how many words are there in file
    """
...
def choose_word(word_list): #random the word
    """
